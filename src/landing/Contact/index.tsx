...
const Contact = () => {
  ...
  return (
    <section id="contato" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-gradient-to-b from-secondary/20 via-transparent to-primary/5" />
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Estamos prontos para ouvir você. Preencha o formulário ou entre em contato 
